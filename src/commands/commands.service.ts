...
// указать id события в сообщении события

// сделать команды: удали, напомни
// // удали должно удалять событие сразу если оно ответом на событие
// // если не ответом то окидать на подтверждение удаления (стандартое, мб сделать другой текст)

// // напомни должна ответом на сообщение кидать на выбор напоминания
// // если не ответом, то искать событие и кидать на выбор напоминания
